...
test -h /etc/resolv.conf && echo "/etc/resolv.conf is a symbolic file" || echo "/etc/resolv.conf is not a symbolic file"
test -d /etc/resolv.conf && echo "/etc/resolv.conf is a directory file" || echo "/etc/resolv.conf is not a directory file"
test -r /etc/resolv.conf && echo "/etc/resolv.conf is a readable file" || echo "/etc/resolv.conf is not a readable file"
test -w /etc/resolv.conf && echo "/etc/resolv.conf is a writable file" || echo "/etc/resolv.conf is not a writable file"
test -x /etc/resolv.conf && echo "/etc/resolv.conf is a executable file" || echo "/etc/resolv.conf is not a executable file"
